...
- Short-address assignment uses `derive_short_addr(EUI-64)` (FNV-1a32 per `02-physical-link.md:§4.5`; collision resolution via `dad_retry` seed mixing when DAD detects duplicate). Signature/replay caches keyed on stable IID.
