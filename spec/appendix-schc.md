...
This reduces typical options overhead from 20-40B (verbatim tail) to 8-15B. See `rust/lichen-schc/src/rules.rs:521`, `python/src/lichen/schc/rules.py:336`, test vectors, and RFC 8724 §10 for TLV patterns. Full rules in constants.toml and schc_compression.json.
