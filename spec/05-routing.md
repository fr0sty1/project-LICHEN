...
|--------------|----------------|---------|
| Link-local (fe80::/10) | On-mesh neighbor | Direct to neighbor |
| Primary (02xx::/7 Yggdrasil-derived per 06-security) | Local mesh peer or Yggdrasil-remote | Gradient/LOADng/RPL first; Yggdrasil fallback if unknown locally |
| Other | Off-mesh | RPL to border router or Yggdrasil |
| Unknown | Off-mesh | Yggdrasil or RPL to border router |

Addresses derived from Ed25519 pubkey (see 06-security.md §8.5 and 04-network.md). The 02xx model enables seamless local + global routing without ULA/GUA layering.
