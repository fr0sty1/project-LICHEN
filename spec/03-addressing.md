...
Cross-references: 04-network.md (§6.1 IPv6 addressing, §6.2 IID derivation, §12), 06-security.md (§8.5 unified key derivation), 08-nodes.md, spec/README.md, related I-Ds.
