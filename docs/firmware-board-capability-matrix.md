...
| Seeed XIAO ESP32-S3 + Wio-SX1262 | ESP32-S3 class | SX1262 via bridge fragment | N/A (BLOCKED) | N/A | BLOCKED: no canonical composite board/shield mapping. xiao_s3_wio_sx1262 fragment retired per project-LICHEN-2u26.10, project-LICHEN-80ju, project-LICHEN-irj9, project-LICHEN-7qaj, project-LICHEN-ndbx, project-LICHEN-aciz (m5m1.8 bridge audit). Use heltec_wifi_lora32_v3/esp32s3/procpu proxy. | N/A | N/A | N/A | Classified FAIL (bridge audit m5m1.8); bridge fragment updated with explicit retirement note. |
