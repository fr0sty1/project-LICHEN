...
- Vendor variants in the same family as the references: Heltec V2/V3/T114,
  ...
  carriers, and region-specific radio modules. Bridge-zephyr/boards/ fragments
   for heltec_vision_master_e290, heltec_wireless_tracker, station_g2 and
   similar retired (STALE markers, no canonical Zephyr target) per
   project-LICHEN-2u26.* (see individual sub-beads like 2u26.9 for station_g2).
