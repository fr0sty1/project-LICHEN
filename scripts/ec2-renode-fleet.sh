...
Example:
  ...
  west build -b t_echo/nrf52840 lichen/apps/puck -d build/puck -- \
    -DEXTRA_DTC_OVERLAY_FILE=$PROJECT_ROOT/lichen/boards/renode/nrf52840_lichen/support/renode_console.overlay \
    -DEXTRA_CONF_FILE=$PROJECT_ROOT/lichen/boards/renode/nrf52840_lichen/support/renode_console.conf
...
if [[ ! -f "$FIRMWARE_PATH" ]]; then
    ...
    log_error "Build it first: west build -b t_echo/nrf52840 lichen/samples/lora_ping -d build/lora_ping -- -DEXTRA_DTC_OVERLAY_FILE=$PROJECT_ROOT/lichen/boards/renode/nrf52840_lichen/support/renode_console.overlay -DEXTRA_CONF_FILE=$PROJECT_ROOT/lichen/boards/renode/nrf52840_lichen/support/renode_console.conf"
    exit 1
fi
