...
"""Integration tests for EDHOC CoAP transport (full handshake flows)."""
...
@pytest.mark.asyncio
async def test_edhoc_handshake_via_coap() -> None:
...
@pytest.mark.asyncio
async def test_edhoc_resource_rejects_empty_payload() -> None:
...
@pytest.mark.asyncio
async def test_edhoc_resource_rejects_unknown_peer() -> None:
