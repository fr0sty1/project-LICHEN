...
Provides :class:`ProxyResource` for LCI baseline mesh access. Clients with
link-local reachability to the gateway use ``/proxy`` with RFC 7252 Proxy-Uri
to reach native 0200::/8 mesh nodes.
