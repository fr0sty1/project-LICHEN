...
from lichen.constants import RPL_TRICKLE_IMAX_DOUBLINGS, RPL_TRICKLE_IMIN_MS, RPL_TRICKLE_K
from lichen.rpl.trickle import TrickleTimer  # noqa: F401  # re-export for oracle parity

# Spec §14.1 table
TRICKLE_IMIN_MS: int = 4000
TRICKLE_IMAX_MS: int = 17 * 60 * 1000  # ~17 minutes (approx); exact Imax = Imin * 2^8 = 1_024_000
TRICKLE_IMAX_EXACT_MS: int = RPL_TRICKLE_IMIN_MS << RPL_TRICKLE_IMAX_DOUBLINGS  # 1_024_000 ms
TRICKLE_K: int = 10
...
def spec_constants_valid() -> bool:
    ...
    return (
        ...
        and RPL_TRICKLE_IMAX_DOUBLINGS == 8
