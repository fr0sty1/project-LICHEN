...
class AnnounceMessage:
    ...
    Attributes:
        ...
        rx_channel: Preferred RX channel for rendezvous (0-15 per CCP-9 da2q). 
            Signed in signed_data() after seq_num (offset in wire format) to prevent tampering per test/vectors/ccp9.json independent oracle. Matches Rust AnnounceBuilder.rx_channel and C structs.
