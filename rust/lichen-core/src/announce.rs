...
//! ```text
//! 0x15 | type(0x01) | flags/rx_channel(u8) | hop(u8) | seq(u16be) | IID(8B) | pubkey(32B) | sig(48B) | [app_data...]
//! ```
//!
//! rx_channel (0-7) is packed in the flags byte (offset 1 after dispatch) and is
//! included in the signed data per CCP-9 to prevent tampering. Total fixed 94 bytes.
//! Matches the _l2_announce_with_channel oracle from test vectors.
