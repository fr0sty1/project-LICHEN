...
const LINK_LOCAL_IPV6_COAP: &[FieldDescriptor] = &[
    FieldDescriptor {
...
const GLOBAL_IPV6_COAP: &[FieldDescriptor] = &[
    FieldDescriptor {
        field_id: "IPv6.version",
        length_bits: 4,
        mo: Mo::Equal,
...
const LINK_LOCAL_OSCORE_FIELDS: &[FieldDescriptor] = LINK_LOCAL_IPV6_COAP;
const GLOBAL_OSCORE_FIELDS: &[FieldDescriptor] = GLOBAL_IPV6_COAP;
pub const LINK_LOCAL_COAP_RULE: Rule = Rule {
    rule_id: RULE_LINK_LOCAL_COAP,
    fields: LINK_LOCAL_IPV6_COAP,
};
pub const GLOBAL_COAP_RULE: Rule = Rule {
    rule_id: RULE_GLOBAL_COAP,
    fields: GLOBAL_IPV6_COAP,
};
