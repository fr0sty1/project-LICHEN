...
fn test_edhoc_interop_vectors() {
    ...
    assert_eq!(v["prk_2e"].as_str().unwrap(), v["prk_2e"].as_str().unwrap());
    assert_eq!(
    ...
    assert_eq!(v["th_2"].as_str().unwrap(), v["th_2"].as_str().unwrap());
    assert_eq!(v["th_3"].as_str().unwrap(), v["th_3"].as_str().unwrap());
    assert_eq!(v["th_4"].as_str().unwrap(), v["th_4"].as_str().unwrap());
    assert_eq!(
