...
impl MeshtasticBridge {
    ...
    pub fn process_incoming(&mut self, packet: &MeshPacket) -> Result<IncomingResult, BridgeError> {
        ...
        match portnum {
            PortNum::IpTunnelApp => {
                // Raw IPv6 packet encapsulated via IP_TUNNEL_APP (portnum 33).
                // Validates IPv6 version and extracts src/dst from standard header.
