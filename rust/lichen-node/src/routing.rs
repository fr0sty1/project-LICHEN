...
impl Router {
    ...
    ///
    /// Non-root nodes always return None (routing table is root-only in non-storing RPL mode per spec/05-routing.md).
    /// Error handling for invalid dst is delegated to routing_table.lookup.
