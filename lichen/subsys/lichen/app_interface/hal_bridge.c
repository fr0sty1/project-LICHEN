	...
	enum lichen_hal_location_source_class source_class)
{
	...
	case LICHEN_APP_LOCATION_SOURCE_NONE:
	case LICHEN_APP_LOCATION_SOURCE_ONBOARD_HARDWARE:
	case LICHEN_APP_LOCATION_SOURCE_EXTERNAL_HARDWARE:
	case LICHEN_APP_LOCATION_SOURCE_LOCAL_CLIENT:
	default:
