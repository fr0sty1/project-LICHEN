...
/** Maximum serialized LICHEN frame size */
#define LICHEN_MAX_FRAME_LEN 255U

/** Maximum LENGTH field value (serialized frame excluding LENGTH itself) */
#define LICHEN_MAX_FRAME_BODY_LEN 254U

/** Maximum payload size for an unsigned broadcast frame */
#define LICHEN_MAX_PAYLOAD 250U
