...
/**
 * Build an exact logical copy using the current Path Sequence.
 *
 * DAOSequence still advances. The caller must supply the same parent and
 * lifetime as the logical update being retransmitted.
 */
