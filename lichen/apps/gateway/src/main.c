...
/* Resolved merge conflict for project-LICHEN-ds5e (worktree-worker24: heltec_wifi_lora32_v3_esp32s3_procpu.conf), project-LICHEN-6rb4: lichen/apps/gateway/src/main.c + Kconfig. Merged RPL root, prefix delegation, and WiFi station
