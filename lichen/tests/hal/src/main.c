...
{
	struct lichen_duty_cycle_tracker t; uint32_t m; lichen_duty_cycle_tracker_init(&t,10); m=3600*10; zassert_equal(lichen_duty_cycle_tracker_remaining_ms(&t,0),m); zassert_equal(lichen_duty_cycle_tracker_usage_permille(&t,0),0); lichen_duty_cycle_tracker_record_tx(&t,0,200); zassert_equal(lichen_duty_cycle_tracker_remaining_ms(&t,1000),m-200); zassert_equal(lichen_duty_cycle_tracker_usage_permille(&t,1000),0); lichen_duty_cycle_tracker_init(&t,10); lichen_duty_cycle_tracker_record_tx(&t,0,200); zassert_equal(lichen_duty_cycle_tracker_remaining_ms(&t,3600201),m); lichen_duty_cycle_tracker_init(&t,10); lichen_duty_cycle_tracker_record_tx(&t,0,36000); zassert_equal(lichen_duty_cycle_tracker_next_tx_available_ms(&t,0,100),3600000); zassert_equal(lichen_duty_cycle_tracker_next_tx_available_ms(&t,0,36001),(uint64_t)-1); lichen_duty_cycle_tracker_init(&t,100); zassert_equal(lichen_duty_cycle_tracker_remaining_ms(&t,0),3600*100); zassert_true(lichen_duty_cycle_tracker_can_transmit(&t,0,100));
}
