...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_LORA_L2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_LORA_L2_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_LORA_L2_RX_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_LORA_L2_RX_PRIORITY, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_IPV6, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LICHEN_IPV6_ULA_PREFIX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_LICHEN_MODULE, 1);
